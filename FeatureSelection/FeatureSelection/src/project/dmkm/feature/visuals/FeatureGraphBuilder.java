...
public class FeatureGraphBuilder {
    ...
    public FeatureGraphBuilder(Graph g)
    {
    	graph = g;
    	setUpVisualization();
		setUpRenderers();
	...
	public JFrame getVisual()
	{
			
				return	AggregateDemo.demo(graph);
	...
	public static void setUpRenderers()
	{
        ...
        ShapeRenderer r = new ShapeRenderer(20);
       ...
       // EdgeRenderer ed = new EdgeRenderer(prefuse.Constants.EDGE_TYPE_CURVE, prefuse.Constants.EDGE_ARROW_NONE);
        
        DefaultRendererFactory drf = new DefaultRendererFactory(r);
      
        // drf.setDefaultEdgeRenderer(ed);
        vis.setRendererFactory(drf);
      //  drf.add(new InGroupPredicate("nodedec"), new LabelRenderer());
	...
	public static void setUpActions()
	{
      ...
      ColorAction fill = new ColorAction("graph.nodes", VisualItem.SHAPE, ColorLib.rgb(0, 200, 0));
